"""
Django settings for albertpointscompanion project.
...
ROOT_URLCONF = 'albertpointscompanion.urls'
...
WSGI_APPLICATION = 'albertpointscompanion.wsgi.application'
...
DATABASES = {
    'default': {
        ...
        'NAME': os.environ.get('POSTGRE_NAME', 'albertpointscompanion'),
        'USER': os.environ.get('POSTGRE_USER', 'apcuser'),
